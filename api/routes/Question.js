...
const { create, getSingleQuestion, getAllQuestions, updateQuestion, deleteQuestion, questionsByCategory, questionsBySubCategory } = require("../controllers/questionController")
